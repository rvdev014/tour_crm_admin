...
use App\Filament\Resources\FlightRequestResource\Pages;
...
class FlightRequestResource extends Resource
{
    ...
    protected static ?string $label = 'Flight Requests';

    protected static ?string $pluralLabel = 'Flight Requests';
    ...
    public static function form(Form $form): Form
    {
        return $form->disabled(fn () => auth()->user()->isOperator())
            ->schema([
                ...
                Forms\Components\Select::make('cabin_class')
                    ->label(__('Cabin Class'))
                    ->native(false)
                    ->options([
                        'economy' => __('Economy'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('cabin_class')
                    ->label(__('Cabin Class')),
