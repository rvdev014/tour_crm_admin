...
/**
 * A train ticket request submitted from the website. There is no live
 * rail search/booking integration — this simply captures the trip
 * details as a lead for an operator to follow up on, the same way
 * FlightRequest does for flights.
 *
 * @property int $id
 ...
 * @property WagonClass|null $wagon_class
